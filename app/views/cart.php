	      	...
	      	<div class="modal-body">
	      		...
	      		<div class="row">
	      			<div class="col-12 col-sm-12 col-md-12 col-lg-12 text-center">
	      				<button type="button" class="btn btn-info btnSlim mr-2" onclick="emptyCart(1)" data-dismiss="modal">YES</button>
	    ...
	    <div class="modal-content bg-light">
	    	<div class="modal-header">
	      	...
	      	<div class="modal-body">
	      		...
	      		<div class="row">
	      			<div class="col-12 col-sm-12 col-md-12 col-lg-12 text-center">
	      				<button type="button" class="btn btn-info btnSlim mr-2" id="btnRemoveCartItem" data-dismiss="modal">YES</button>
      					<button type="button" class="btn btn-dark btnSlim" data-dismiss="modal">NO</button>
	      			</div>
	      		</div>
	      	</div> <!-- end of modal-body -->
